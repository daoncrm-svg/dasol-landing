...
async function deliverMetaCAPI(submission, req, env, fetchImpl) {
  // 사용자가 제공한 토큰 (보안상 좋진 않지만 멘토링/VIBE 코딩 실습을 위해 1차 하드코딩)
  const accessToken = env.META_CAPI_ACCESS_TOKEN || 'EAANtPoWMbaQBRBgyB8PN2UFqRiTB8m7R7YkbCZASvYswZA6e3qZBihZAIPcJ5oqKF5R5cDD8sB8MjaCW2ZBvsb9rANZB4J9B0vBg9tTWgTWY1oh8eTKknQOCxhQG3ltfsolPfIdTI3Bx6rLN6PNwZBt7QVhSLXKfcbKa5f6ci5M45L1AZAIv1oVou1jYQFYzOAZDZD';
  const pixelId = '1980194052630383';
